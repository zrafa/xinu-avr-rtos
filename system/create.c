	...
	)
{
	...
	*saddr-- = (char)STACKMAGIC;		/* Bottom of stack */
	prptr->pargs = nargs;
...
{
	uint16	i;			/* iterate through all processes*/
//	static	pid16 nextpid = 1;	/* position in table to try or	*/
	static	pid16 nextpid = 0;	/* position in table to try or	*/
